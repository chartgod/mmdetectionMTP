...
# 로그 파일 경로 설정
all_trials_log_file_path = '/home/lsh/share/CD/open-cd/tools/hpbandster_trials_log.txt'
...
class MyWorker(Worker):
    ...
    def compute(self, config, budget, **kwargs):
        ...
        log_file_path = f'/home/lsh/share/CD/open-cd/tools/hpbandster_trial_log.txt'
...
NS = hpns.NameServer(run_id='bohb', host='localhost', port=9091)
NS.start()

worker = MyWorker(nameserver='localhost', run_id='bohb', nameserver_port=9091, timeout=120)
