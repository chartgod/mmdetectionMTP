...
# 로그 파일 경로 설정
all_trials_log_file_path = '/home/lsh/share/CD/open-cd/tools/changer_hpbandster_trials_log34.txt'
...
class MyWorker(Worker):
    ...
    def compute(self, config, budget, **kwargs):
        ...
        log_file_path = f'/home/lsh/share/CD/open-cd/tools/changer_hpbandster_trial_log34.txt'
