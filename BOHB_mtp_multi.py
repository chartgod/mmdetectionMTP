...
all_trials_log_file_path = '/home/lsh/share/mmsatellite/mtp_bohb/hpbandster_mtp_trials_log_multitest.txt'
...
class MyMTPWorker(Worker):
    ...
    def compute(self, config, budget, **kwargs):
        ...
        modified_config_path = '/home/lsh/share/mmsatellite/mtp_bohb/hpbandster_temp_mtp_config_multitest.py'
        cfg.dump(modified_config_path)

        # Log path for individual trial
        log_file_path = f'/home/lsh/share/mmsatellite/mtp_bohb/hpbandster_mtp_trial_log_multitest1.txt'
            ...
            with open(log_file_path, 'w') as log_file:
                subprocess.run(
                    [
                        ...
                        '/home/lsh/share/mmsatellite/train_multi1234.py',
                        '--config', modified_config_path,
                        '--work-dir', '/home/lsh/share/mmsatellite/MTP_trainer/test용'
                    ],
                    stdout=log_file, stderr=log_file, check=True, 
                    env={**os.environ, "CUDA_VISIBLE_DEVICES": "1,2,3,4"}
                )
