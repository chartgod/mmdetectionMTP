...
# 로그 파일 경로 설정
all_trials_log_file_path = '/home/lsh/share/CD/open-cd/tools/changer_hpbandster_trials_log.txt'
...
class MyWorker(Worker):
    ...
    def compute(self, config, budget, **kwargs):
        ...
        config_path = '/home/lsh/share/CD/open-cd/configs/changer/changer_ex_r18_512x512_40k_levircd베이지안.py'
        ...
        modified_config_path = '/home/lsh/share/CD/open-cd/tools/changer_hpbandster_temp_config.py'
        cfg.dump(modified_config_path)

        # 학습 로그를 파일로 저장하기 위해 로그 경로 지정
        log_file_path = f'/home/lsh/share/CD/open-cd/tools/changer_hpbandster_trial_log.txt'

        # 학습 시작
        try:
            with open(log_file_path, 'w') as log_file:
                subprocess.run(
                    ['python', '/home/lsh/share/CD/open-cd/tools/train.py', modified_config_path],
            ...
            with open(all_trials_log_file_path, 'a') as log_file:
                log_file.write(f'F1-score: {f1}, Precision: {precision}, Recall: {recall}\n')
